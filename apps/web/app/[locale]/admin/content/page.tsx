// What the game is made of — step K.1.
//
// One section, one address. The body is what track I already drew; K.8
...
export const metadata: Metadata = { robots: robotsFor('/admin/content') };
