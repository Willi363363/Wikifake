// The arrivals counter — step K.1.
//
// One section, one address. The body is what track I already drew; K.6
...
export const metadata: Metadata = { robots: robotsFor('/admin/traffic') };
