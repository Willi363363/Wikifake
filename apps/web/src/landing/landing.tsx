...
export function Landing() {
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-16">
      ...
      <section aria-labelledby="landing-source" className="mt-20">
        <h2 id="landing-source" className="text-3xl text-ink">
          {t('beats.source.title')}
        </h2>
        <p className="mt-3 max-w-[60ch] text-base text-ink-2">{t('beats.source.body')}</p>
      ...
      <section aria-labelledby="landing-collision" className="mt-20">
      ...
      <section aria-labelledby="landing-score" className="mt-20">
        <h2 id="landing-score" className="text-3xl text-ink">
          {t('beats.score.title')}
        </h2>
        <p className="mt-3 max-w-[60ch] text-base text-ink-2">{t('beats.score.body')}</p>
        <Scoreboard />
        <div className="mt-8">
          <WayIn label={t('play')} />
        </div>
      ...
      {/* Required, not decoration: this page quotes Wikipedia and shows a
