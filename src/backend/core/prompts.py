...
Basé sur le contenu Wikipedia suivant sur le sujet "{topic}", modifie des paragraphes afin de les rendre entièrement faux qui :
...
Modifie uniquement les paragraphes, séparés par un double saut de ligne, sans aucun préfixe ni numéro de liste :
"""
