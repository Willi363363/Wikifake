...
export const MARK_STYLES: Readonly<Record<string, string>> = {
  ...
  MARK_STYLE_CORNER:
    'inset-1 border-2 [clip-path:polygon(0_0,25%_0,25%_25%,0_25%,0_75%,25%_75%,25%_100%,0_100%,100%_100%,75%_100%,75%_75%,100%_75%,100%_25%,75%_25%,75%_0,100%_0)]',
};
...
export const FRAMES: Readonly<Record<string, string>> = {
  ...
  FRAME_DOUBLE: 'border-4 border-double border-line-strong px-1',
  FRAME_NOTCHED:
    'border-2 border-line-strong px-1 [clip-path:polygon(6px_0,100%_0,100%_calc(100%-6px),calc(100%-6px)_100%,0_100%,0_6px)]',
};
