...
*Moved here from `05-known-debt.md` on 2026-09-17: neither is a defect with a
`file:line`, both are consequences of this plan, and this is the file somebody
reads before changing a timeout.*
