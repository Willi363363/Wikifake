...
| Q | Resilience — the unheld promise, and a budget off the wrong host | 🔶 Q.1 done — the client outlasts a cold start again; three unheld promises and an orphan remain | `product/18-resilience.md` |
