...
| C | Landing — the scroll scene | 🔶 in progress — C.1 to C.6 | `product/03-landing.md` |
| D | Game surface | ✅ done — every screen on the direction, 24 journeys unchanged | `product/04-game-surface.md` |
| E | Accounts and player statistics | 🔶 E.2 done; E.1 awaiting OAuth credentials | `product/05-accounts.md` |
