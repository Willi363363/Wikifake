# Track N — playing the day

What N.5, N.6 and N.7 decided: the round on the day's article, the board that
ranks it, and the way a player reaches either. The steps that *make* the day are
in `15-daily-article-steps.md`; the frame and the step table are in
`15-daily-article.md`.
