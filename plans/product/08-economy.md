...
| | |
|---|---|
| **State** | 🔶 H.1 to H.3 — the ledger, its balance, and earning |
| **Branch** | `feat/economy` |
...
**What each step decided** is in two sheets: `08-economy-ledger.md` carries H.1
and H.2, and `08-economy-earning.md` carries H.3. The table above is the only
