/** Capture d'un paragraphe suspect. */

import { useState, useEffect, useRef } from 'react';

// Les paragraphes arrivent en props (avant : lecture de la globale
// `window.WIKIFAKE_BODY`, qui rendait ce composant intestable et couple).
function FlagCaptureModal({ articleTitle, paragraphs = [], onSubmit, onClose }) {
...
export default FlagCaptureModal;
