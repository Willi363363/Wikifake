/**
 * Reaction Speed mini-game for the waiting screen.
 *
 * A target appears after a random delay; clicking it measures reaction time.
 * Clicking during the wait counts as a false start and restarts the round.
 */
