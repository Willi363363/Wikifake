/**
 * Snake mini-game for the waiting screen (formerly `SnakeGame`).
 *
 * 24×24 grid rendered with absolutely-positioned 10px cells. Speed ramps up
 * with score (150ms down to a 60ms floor).
 */
