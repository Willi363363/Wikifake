/**
 * Memory Cards mini-game for the waiting screen.
 *
 * Classic flip-and-match: 4 icon pairs shuffled into 8 cards. A lock ref
 * prevents flipping while a pair is being resolved.
 */
