/**
 * Dino Run ("Agent Dash") mini-game for the waiting screen (formerly `DinoGame`).
 *
 * Chrome-dino clone: refs drive the 20ms game loop so jump/obstacle physics
 * stay smooth without re-render churn; state mirrors what must be drawn.
 */
