/** Panneau des indices (cout facture par le serveur). */
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <LabelMono style={{ fontSize: 9 }}>Intel — demander un indice</LabelMono>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <Chip color="var(--bronze)" bg="white" border="rgba(140,109,54,0.20)">Indice −50</Chip>
            <Chip color="var(--danger)" bg="white" border="rgba(166,75,72,0.20)">Localiser −200</Chip>
