/**
 * SubjectCard — right-sidebar card summarising the article subject: portrait
 * placeholder, fact rows, and confirmed/marked progress. Ported from hud.jsx.
 */
import { LabelMono, PulseDot, DataRow, HairProgress, Chip } from '../../components/ui';
