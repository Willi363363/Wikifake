/**
 * Full-screen confetti burst for the CONFETTI "malus" (pure distraction).
 *
 * Pieces are memoised once; they fall on the same `snowfall` keyframe as the
 * blizzard flakes. Sits at zIndex 160 — above the other overlays.
 */
