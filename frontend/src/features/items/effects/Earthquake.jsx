/**
 * Full-screen seismic overlay for the EARTHQUAKE malus.
 *
 * The actual page shaking is done by the `earthquake-active` class on the
 * article shell (styles/effects.css); this overlay adds the lava flash,
 * crack lines and debris. Debris positions are memoised once.
 */
import { useMemo } from 'react';

export function Earthquake({ active }) {
