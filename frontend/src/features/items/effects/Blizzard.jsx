/**
 * Full-screen blizzard overlay for the FREEZE_TIME malus.
 *
 * The flakes are generated once (useMemo) so they do not jump around on each
 * render; the keyframes (`snowfall`, `frost-pulse`, `damage-pop`) live in
 * styles/animations.css.
 */
import { useMemo } from 'react';

export function Blizzard({ active }) {
