// Vendored from the Claude Design prototyping harness — kept as-is on purpose.
//
// This panel only appears when a design host activates edit mode, so it is
// invisible during normal play. `useTweaks` is what the app actually depends
// on: it holds mode / difficulty / accent / screen state and mirrors edits back
// to the host. Converted to ES modules; the logic below is untouched.
